...
# AMD64
wget https://github.com/Karrari-Dev/Netrix-/releases/download/v2.0.4/netrix-amd64.tar.gz
tar -xzf netrix-amd64.tar.gz
mv netrix /usr/local/bin/

# ARM64
wget https://github.com/Karrari-Dev/Netrix-/releases/download/v2.0.4/netrix-arm64.tar.gz
