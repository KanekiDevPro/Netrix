...
# AMD64
wget https://github.com/Karrari-Dev/Netrix-/releases/download/v3.0.0/netrix-amd64.tar.gz
tar -xzf netrix-amd64.tar.gz
mv netrix /usr/local/bin/

# ARM64
wget https://github.com/Karrari-Dev/Netrix-/releases/download/v3.0.0/netrix-arm64.tar.gz
